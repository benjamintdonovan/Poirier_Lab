function [output_args] = Analyzedwelltimes6(fname,sn)%,framerate,numFrames,sn)%,shutteropen)
%enter frame rate in 'sec per frame'
%note frame rate is set to 1 rn. This will just give you the rates in terms
%of frame
framerate = 1
numFrames = 2000
%The longest trace is about 2000 frames. So I'll make a list with 20000 0s
%for the FRETmatrix. All '0' values will be deleted anway
%AnalyzeDwlltimes2 finds time protein spends on (bound) and off (unbound) Nuc. Outputs these as
